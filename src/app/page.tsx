...
export default function HomePage() {
  ...
  const handleScanSuccess = useCallback(async (scannedData: { qrData: string, subject: string, status: 'Logged In' | 'Logged Out' }) => {
    ...
    // Step 1: Try to find a matching code in local cache or Firestore.
    // This is for QR codes generated by this app.
    ...
    // Step 2: If no matching code was found, assume it's a third-party QR
    // and use its raw text content as the name. Mark it as not valid
    // because it's not a code managed by our system.
    if (!studentName) {
